...
def get_category_names(categories):
    ...
    print "#PileUp(High, Low, All)=(0,1,2) DATA(mc,data)=(0,1) Detector(EB,EE)=(0,1) R9(high, low, all)=(0,1,2) Pt(0,1,2,3,4,5,6) Correction(scale,resolution)=(0,1)"
    # Print Scales
