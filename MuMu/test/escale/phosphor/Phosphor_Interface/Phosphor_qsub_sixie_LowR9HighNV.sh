...
QSUBDIR=/home/vlambert/scratch_phosphor/CMSSW_4_2_8/src/JPsi/MuMu/test/escale/phosphor/Phosphor_Interface/QsubScripts_sixie_LowR9_ExpFit_HNV

NEWDIR=`date | gawk '{ print $1 $2 $3"_" $6 }'`
RESULTS=HighNV_2012Full_LowR9
LOGS=HighNV_2012Full_LowR9_Logs
TreeVer="sixie"
