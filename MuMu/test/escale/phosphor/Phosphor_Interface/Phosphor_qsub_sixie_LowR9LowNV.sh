...
QSUBDIR=/home/vlambert/scratch_phosphor/CMSSW_4_2_8/src/JPsi/MuMu/test/escale/phosphor/Phosphor_Interface/QsubScripts_sixie_LowR9_ExpFit_LNV

NEWDIR=`date | gawk '{ print $1 $2 $3"_" $6 }'`
RESULTS=LowNV_2012Full_LowR9
LOGS=LowNV_2012Full_LowR9_Logs
TreeVer="sixie"
