...
QSUBDIR=/home/vlambert/scratch_phosphor/CMSSW_4_2_8/src/JPsi/MuMu/test/escale/phosphor/Phosphor_Interface/QsubScripts_sixie_High9_ExpFit_HNV

NEWDIR=`date | gawk '{ print $1 $2 $3"_" $6 }'`
RESULTS=HighNV_2012Full_HighR9
LOGS=HighNV_2012Full_HighR9_Logs
TreeVer="sixie"
