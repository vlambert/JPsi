...
def xyasymmerrors_var_vs_var_getter_factory(xvarname, yvarname):
    ...
    eylgetter = rfit_low_error_getter_factory(yvarname)
    eyhgetter = rfit_high_error_getter_factory(yvarname)
...
for cat in categories:
    ...
    for title, version in [('Jan12 rereco + Rochcor', 'yyv5'),
        ...
        cfg.getters.append(
            xyasymmerrors_var_vs_var_getter_factory('phoResTrue',
                                                    'phoRes')
            )
