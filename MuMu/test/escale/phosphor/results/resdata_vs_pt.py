...
def do_barrel_highr9_fits():
    ...
    fitter = Fitter(
        filename  = _filename,
        graphname = 'regressions_resdata_EB_highR9_jan2012rereco',
        name      = 'PhotonResolutionVsEt_DataFit_Barrel_highR9',
        title     = 'Barrel, R9 > 0.94, Data Fit',
        systematics = systematics,
        yrange    = (-1, 6),
        )
    fitter.run()
    ...
    fitter = Fitter(
        ...
        title     = 'Barrel, R9 > 0.94, Data Fit, S from TB',
        systematics = systematics,
        yrange    = (-1, 6),
        )
    fitter.S.setVal(_stochastic_from_tb/1.16)
    ...
    fitter = Fitter(
        ...
        title     = 'Barrel, R9 > 0.94, Data Fit, N from MC',
        systematics = systematics,
        yrange    = (-1, 6),
        )
    fitter.S.setVal(_stochastic_from_tb/1.16)
    ...
    fitter = Fitter(
        ...
        title     = 'Barrel, R9 > 0.94, Data Fit, S from TB, N from MC',
        systematics = systematics,
        yrange    = (-1, 6),
        )
    fitter.S.setVal(_stochastic_from_tb/1.16)
...
def do_barrel_lowr9_fits():
    ...
    fitter = Fitter(
        filename  = _filename,
        graphname = 'regressions_resdata_EB_lowR9_jan2012rereco',
...
def do_endcap_allr9_fits():
    ...
    fitter = Fitter(
        ...
        name      = 'PhotonResolutionVsEt_DataFit_Endcaps_allR9',
    ...
    fitter = Fitter(
        filename  = _filename,
        graphname = 'regressions_resdata_EE_jan2012rereco',
        name      = 'PhotonResolutionVsEt_DataFit_Endcaps_allR9_SfromTB',
    ...
    fitter = Fitter(
        filename  = _filename,
        graphname = 'regressions_resdata_EE_jan2012rereco',
        name      = 'PhotonResolutionVsEt_DataFit_Endcaps_allR9_NfromMC',
        title     = 'Endcaps, Data Fit, N from MC',
        systematics = systematics,
        )
    fitter.S.setVal(_stochastic_from_tb/1.91)
    ...
    fitter = Fitter(
        filename  = _filename,
        graphname = 'regressions_resdata_EE_jan2012rereco',
        name      = 'PhotonResolutionVsEt_DataFit_Endcaps_allR9_SfromTB_NfromMC',
...
def do_endcap_highr9_fits():
    ...
    fitter = Fitter(
        filename  = _filename,
        graphname = 'regressions_resdata_EE_highR9_jan2012rereco',
