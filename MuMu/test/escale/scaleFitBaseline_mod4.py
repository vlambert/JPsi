'''
Perform fit for scale with the s-method as for Baseline except for:
  o Fit s only in the shortes range covering 90% of the data
  o Relax the m(yy) cut to m(yy) < 85 GeV
'''
...
from JPsi.MuMu.scaleFitter import DimuonPlusDimuonGammaMassSumMax
...
for fit in defaultfits:
    fit.applyDefinitions([DimuonPlusDimuonGammaMassSumMax(190)])
...
ws1.writeToFile('mc_sreco_strue_Baseline_mod4.root')
