...
for fitter in _fits[:]:
    ...
    for j in range(10):        
        ...
        param_fitted_data.add(fitter.parameters)

    ws1.Import(param_init_data)
    ws1.Import(param_fitted_data)
        
    fitter.param_init_data = param_init_data
    fitter.param_fitted_data = param_fitted_data
