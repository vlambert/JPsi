...
sampled from RooKeysPdfs and interpolated to first order.
...
pdf4 = ROOT.RooKeysPdf('pdf4', 'pdf4', mmgMass, sdata4, mirror, 1.5)
pdf8 = ROOT.RooKeysPdf('pdf8', 'pdf8', mmgMass, sdata8, mirror, 1.5)
