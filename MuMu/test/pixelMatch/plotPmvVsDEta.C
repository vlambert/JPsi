// void plotPmvVsDr()
{
  ...
  h_dEta_EB_zfsr = (TH1F*) _file0->Get("h_dEta_EB_zfsr");
  h_dEta_EB_data38x = (TH1F*) _file0->Get("h_dEta_EB_data38x");
  h_dEta_EB_pass_zfsr = (TH1F*) _file0->Get("h_dEta_EB_pass_zfsr");
  h_dEta_EB_pass_data38x = (TH1F*) _file0->Get("h_dEta_EB_pass_data38x");


  TGraphAsymmErrors *gr = new TGraphAsymmErrors();
  gr->BayesDivide(h_dEta_EB_pass_zfsr, h_dEta_EB_zfsr);
  gr->GetXaxis()->SetTitle("#Delta#eta(#mu_{near},#gamma)");
  ...
  gr->BayesDivide(h_dEta_EB_pass_data38x, h_dEta_EB_data38x);
  gr->GetXaxis()->SetTitle("#Delta#eta(#mu_{near},#gamma)");
  gr->GetYaxis()->SetTitle("Pixel Match Veto Efficiency");
  ...
  TH1F *hpass0 = h_dEta_EB_pass_zfsr;
  TH1F *htot0  = h_dEta_EB_zfsr;
  ...
  hpass0 = h_dEta_EB_pass_data38x;
  htot0  = h_dEta_EB_data38x;
