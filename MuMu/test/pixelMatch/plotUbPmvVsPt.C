// void plotPmvVsDr()
{
  TFile *_file0 = new TFile("pixelMatchHistos_Nov4ReReco_Fall10_v3.root");

  h_phoPt_ub_EB_zfsr = (TH1F*) _file0->Get("h_phoPt_ub_EB_zfsr");
  h_phoPt_ub_EB_data38x = (TH1F*) _file0->Get("h_phoPt_ub_EB_data38x");
  h_phoPt_ub_EB_pass_zfsr = (TH1F*) _file0->Get("h_phoPt_ub_EB_pass_zfsr");
  h_phoPt_ub_EB_pass_data38x = (TH1F*) _file0->Get("h_phoPt_ub_EB_pass_data38x");


  TGraphAsymmErrors *gr = new TGraphAsymmErrors();
  gr->BayesDivide(h_phoPt_ub_EB_pass_zfsr, h_phoPt_ub_EB_zfsr);
  gr->GetXaxis()->SetTitle("p_{T}^{#gamma} (GeV/c)");
  ...
  gr->BayesDivide(h_phoPt_ub_EB_pass_data38x, h_phoPt_ub_EB_data38x);
  gr->GetXaxis()->SetTitle("p_{T}^{#gamma} (GeV/c)");
  gr->GetYaxis()->SetTitle("Pixel Match Veto Efficiency");
  ...
  TH1F *hpass0 = h_phoPt_ub_EB_pass_zfsr;
  TH1F *htot0  = h_phoPt_ub_EB_zfsr;
  double xbins[] = {0., 5., 100.};
  ...
  hpass0 = h_phoPt_ub_EB_pass_data38x;
  htot0  = h_phoPt_ub_EB_data38x;
